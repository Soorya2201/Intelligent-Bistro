...
export type CustomizationCatalogue = Record<string, CustomizationGroup[]>;
...
export const CUSTOMIZATION_CATALOGUE: CustomizationCatalogue = {
  ...
  'warm-brownie': [
    {
      ...
      options: [
        ...
        { id: 'caramel',      label: '+Caramel Drizzle', priceDelta: 0.75 },
...
export function getCustomizationGroups(itemId: string): CustomizationGroup[] {
  return CUSTOMIZATION_CATALOGUE[itemId] ?? [];
}
